//ADAPTED FROM Stefan Gustavson SimplexNoise1234
//https://github.com/stegu/perlin-noise/blob/master/src/simplexnoise1234.c

//array containing [0-255] twice
const permutation = [
  151,
  160,
  137,
...
export function snoise2(x, y) {
  ...
  var xs = x + s;
  var ys = y + s;
  var i = Math.floor(xs); //floor
  var j = Math.floor(ys); //floor
  ...
  if (t0 < 0) n0 = 0;
    ...
    t0 *= t0;
    n0 = t0 * t0 * grad2(permutation[ii + permutation[jj]], x0, y0);
  }
  ...
  if (t1 < 0) n1 = 0;
    ...
    t1 *= t1;
    n1 = t1 * t1 * grad2(permutation[ii + i1 + permutation[jj + j1]], x1, y1);
  }
  ...
  if (t2 < 0) n2 = 0;
    ...
    t2 *= t2;
    n2 = t2 * t2 * grad2(permutation[ii + 1 + permutation[jj + 1]], x2, y2);
  }
